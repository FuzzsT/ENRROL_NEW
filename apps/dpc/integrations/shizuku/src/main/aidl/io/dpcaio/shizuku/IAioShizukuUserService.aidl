...
interface IAioShizukuUserService {
    ...
    int revokeRuntimePermission(String packageName, String permissionName, int userId);
    ...
    int setComponentEnabledState(String packageName, String className, String state, int userId);
