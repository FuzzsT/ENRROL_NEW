...
DPC-AIO 1.3.0 preserves the 1.0.2 QR Production Readiness invariants and adds protected operations, transactional mutation/rollback, capability-routed Android/Knox/SEM/OEM handling, Package Trust 2.0, hardened APK+ import, Work Profile Lifecycle 2.0 and Credential Recovery 2.0.
