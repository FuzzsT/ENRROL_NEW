...
def main():
    mode = must('app-dpc/src/main/kotlin/io/dpcaio/app/ProvisioningModeActivity.kt', 'EXTRA_PROVISIONING_ALLOWED_PROVISIONING_MODES')
    ...
    must('app-dpc/src/main/kotlin/io/dpcaio/app/PolicyComplianceActivity.kt', 'setResult(RESULT_OK)')
    manifest = must('app-dpc/src/main/AndroidManifest.xml', 'android.app.action.GET_PROVISIONING_MODE')
