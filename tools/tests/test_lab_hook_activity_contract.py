...
def main():
    bridge=(ROOT/'lab-tools/src/main/kotlin/io/dpcaio/lab/LabHookActivityBridge.kt').read_text()
    route=(ROOT/'lab-tools/src/main/kotlin/io/dpcaio/lab/LabHookActivityRouteExecutor.kt').read_text()
    planner=(ROOT/'activity-launcher/src/main/kotlin/io/dpcaio/activity/ActivityAccessPlanner.kt').read_text()
