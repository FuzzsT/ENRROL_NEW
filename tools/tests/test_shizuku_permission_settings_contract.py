...
def main():
    aidl=(ROOT/'shizuku-adapter/src/main/aidl/io/dpcaio/shizuku/IAioShizukuUserService.aidl').read_text()
    impl=(ROOT/'shizuku-adapter/src/main/kotlin/io/dpcaio/shizuku/AioShizukuUserService.kt').read_text()
